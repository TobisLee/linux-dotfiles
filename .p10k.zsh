# Generated by Powerlevel10k configuration wizard on 2020-08-01 at 15:53 CST.
...
#   typeset -g POWERLEVEL9K_VIRTUALENV_{LEFT,RIGHT}_DELIMITER=
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='#9AEDFE'   # default foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_{COMMITS_AHEAD,COMMITS_BEHIND}_CHANGESFORMAT_FOREGROUND=$cyan
