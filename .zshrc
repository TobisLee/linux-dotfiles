...
alias syu='sudo -S pacman -Syu'
alias syyu='sudo -S pacman -Syyu'
alias install='sudo pacman -S'
alias pkgnums='pacman -Q | wc -l'
alias uninstall='sudo pacman -R'

alias dlon='source activate deeplearning'
alias dloff='conda deactivate'
alias jlupc='nohup python2 ./newclient.py > drcom_client.log 2>&1 &'
alias jl='jlupc'
...
alias dkserrestart='systemctl restart docker.service'
alias dkserstart='systemctl start docker.service'
alias dkserstop='systemctl stop docker.service'
alias dkrmiall='docker rmi $(docker images -a -q)'
alias dkrmall='docker rm $(docker ps -a -q)'
alias dkattach='docker attach '
alias dkstart='docker start '
alias dkstop='docker stop '
alias dkps='docker ps -a'
alias dklistim='docker images'
...
alias dotfiles='/usr/bin/git --git-dir=/home/tlss/.dotfiles/ --work-tree=/home/tlss'
...
# eval "$(ssh-agent -s)"
# ssh-add ~/.ssh/id_rsa_b23422080ti
